  ...
  server.registerTool(
    'infer_folder_conventions',
    {
      ...
      inputSchema: {
        ...
        min_confidence: z.number().min(0).max(1).optional().describe('Minimum confidence threshold (0.0-1.0). Default 0.5.'),
      },
    },
  ...
  server.registerTool(
    'find_incomplete_notes',
    {
      ...
      inputSchema: {
        ...
        min_frequency: z.number().min(0).max(1).optional().describe('Minimum field frequency to consider "expected" (default 0.7).'),
