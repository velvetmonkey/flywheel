...
export function registerPrimitiveTools(
  ...
  server.registerTool(
    'get_stale_notes',
    {
      ...
      inputSchema: {
        days: z.number().describe('Notes not modified in this many days'),
        min_backlinks: z.number().default(1).describe('Minimum backlinks to be considered important'),
  ...
  server.registerTool(
    'get_contemporaneous_notes',
    {
      ...
      inputSchema: {
        ...
        hours: z.number().default(24).describe('Time window in hours'),
        limit: z.number().default(50).describe('Maximum number of results to return'),
        offset: z.number().default(0).describe('Number of results to skip (for pagination)'),
      },
    },
  ...
  server.registerTool(
    'get_link_path',
    {
      ...
      inputSchema: {
        ...
        max_depth: z.number().default(10).describe('Maximum path length to search'),
      },
    },
  ...
  server.registerTool(
    'find_dead_ends',
    {
      ...
      inputSchema: {
        folder: z.string().optional().describe('Limit to notes in this folder'),
        min_backlinks: z.number().default(1).describe('Minimum backlinks required'),
        limit: z.number().default(50).describe('Maximum number of results to return'),
        offset: z.number().default(0).describe('Number of results to skip (for pagination)'),
      },
    },
  ...
  server.registerTool(
    'find_sources',
    {
      ...
      inputSchema: {
        folder: z.string().optional().describe('Limit to notes in this folder'),
        min_outlinks: z.number().default(1).describe('Minimum outlinks required'),
        limit: z.number().default(50).describe('Maximum number of results to return'),
        offset: z.number().default(0).describe('Number of results to skip (for pagination)'),
      },
    },
