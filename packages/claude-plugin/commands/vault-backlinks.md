---
skill: vault-backlinks
---

# /vault-backlinks - Note Connection Navigator
...
```
/vault-backlinks Project.md          # Specific note
/vault-backlinks [[My Project]]      # By wikilink name
/vault-backlinks                     # Current context note
```
