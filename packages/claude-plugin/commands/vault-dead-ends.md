---
skill: vault-dead-ends
---

# /vault-dead-ends - Find Notes With No Outgoing Links
...
```
/vault-dead-ends                     # Find all dead-end notes
/vault-dead-ends projects/           # Dead-ends in folder
```
