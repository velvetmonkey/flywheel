---
skill: vault-concurrent
---

# /vault-concurrent - Find Contemporaneous Notes
...
```
/vault-concurrent Project.md         # Notes edited near Project
/vault-concurrent Project.md 48      # Within 48 hours
```
