...
# /run-rollup - Execute Note Rollup Chain
...
```
/run-rollup                    # Process last 2 months (default)
/run-rollup december           # Process specific month
/run-rollup 2025-Q4            # Process specific quarter
/run-rollup weekly only        # Just daily → weekly
```
