...
```
/search type:project           # Find notes by field value
/search #work                  # Find notes with tag
/search projects/ status:active # Folder + field filter
/search title:meeting          # Title contains "meeting"
```
