---
skill: vault-bidirectional
---

# /vault-bidirectional - Find Mutual Links
...
```
/vault-bidirectional                 # All mutual links in vault
/vault-bidirectional Project.md      # Mutual links for specific note
```
